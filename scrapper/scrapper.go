...
const baseUrl string = "https://lolchess.gg/leaderboards"
...
func getPage(pageNum int, mainChannel chan<- []summoner) {
	channel := make(chan summoner)
	pageUrl := baseUrl + "?mode=ranked&region=kr&page=" + strconv.Itoa(pageNum)
